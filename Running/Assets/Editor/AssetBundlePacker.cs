...
//		AssetDatabase.Refresh ();
		...
		BuildPipeline.BuildAssetBundles (Application.streamingAssetsPath + "/android/", BuildAssetBundleOptions.ForceRebuildAssetBundle, BuildTarget.Android);
		BuildPipeline.BuildAssetBundles (Application.streamingAssetsPath + "/ios/", BuildAssetBundleOptions.ForceRebuildAssetBundle, BuildTarget.iOS);
		AssetDatabase.Refresh ();
...
//		stockPath = Application.streamingAssetsPath + "/ios/" + assetName + ".assetbundle";
...
//		}
		...
		string stockPath_ios = Application.streamingAssetsPath + "/ios/" + assetName + ".assetbundle";
		string stockPath_android = Application.streamingAssetsPath + "/android/" + assetName + ".assetbundle";
		BuildTarget buildTarget_ios = BuildTarget.iOS;
		BuildTarget buildTarget_android = BuildTarget.Android;

		if (BuildPipeline.BuildAssetBundle (null, outputArray, stockPath_android, BuildAssetBundleOptions.CollectDependencies, buildTarget_android)) {
			AssetDatabase.Refresh ();
			Debug.Log ("GetAsset android " + assetName + " successfully");
		} else {
			Debug.LogWarning ("GetAsset android " + assetName + " unsuccessfully");
		}

		if (BuildPipeline.BuildAssetBundle (null, outputArray, stockPath_ios, BuildAssetBundleOptions.CollectDependencies, buildTarget_ios)) {
			AssetDatabase.Refresh ();
			Debug.Log ("GetAsset ios " + assetName + " successfully");
		} else {
			Debug.LogWarning ("GetAsset ios " + assetName + " unsuccessfully");
		}
	}

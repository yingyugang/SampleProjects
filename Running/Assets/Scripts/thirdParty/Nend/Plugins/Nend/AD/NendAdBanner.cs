namespace NendUnityPlugin.AD
{
    ...
    public class NendAdBanner : NendAd
    {
        ...
        {
            // Account Setting
            NendUnityPlugin.Common.NendUtils.Account account = new NendUnityPlugin.Common.NendUtils.Account();
            NendUnityPlugin.Common.NendUtils.NendID iosNendID = new NendUnityPlugin.Common.NendUtils.NendID();
            NendUnityPlugin.Common.NendUtils.NendID andNendID = new NendUnityPlugin.Common.NendUtils.NendID();
            account.iOS = iosNendID;
            account.android = andNendID;
            iosNendID.apiKey = "aef7087b6acb2ab5375ff370a1b17829c81901d7";
            iosNendID.spotID = 621925;
            andNendID.apiKey = "1a589bf3e30b5184624d751a917b485dc43119da";
            andNendID.spotID = 621929;
            this.account = account;
            this.outputLog = true;

            // Position Setting
            this.gravity = new Gravity[2]{ Gravity.BOTTOM, Gravity.CENTER_HORIZONTAL };

SuperCharacterController v 1.1.0 Unity package, by Erik Ross.
...
Makes use of RPGMesh and RPGTriangleTree scripts from the RPGController package written by Unity forums user fholm.
